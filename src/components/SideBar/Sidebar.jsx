...
function Sidebar({isOpen, onCloseSidebar, onAddCard, onRemoveCard, cards, onUpdateDeck, onClearAll}){
    ...
    return (
        ...
        >
            ...
            <div className="sidebar-content-container">
                ...
                />
                <Button className="update-btn" label={"Update Cards"} img={update_btn} onClick={onUpdateDeck} />
            </div>
        </div>
    )
}
