...
function SideHeader({ onCloseSidebar, isActive }) {
    const buttonClassName = isActive ? "sidebar-flash-cards-btn active" : "sidebar-flash-cards-btn";

    return (
        <header className="sideHeader">
            <div className="sideHeader-category-container">
                <Button img={flash_cards} imgAlt="flash-cards" className={buttonClassName} />
            </div>
